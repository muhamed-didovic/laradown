...
module.exports = class Crawler {
    ...
    findVideoUrl(str, url) {
        ...
        if (res !== null) {
            if (typeof res[0] !== "undefined") {
                ...
                // console.log('url', url, video.quality);
                /*if (!videoURL) {
    ...
    async _vimeoRequest(course) {
        ...
        try {
            ...
            const v = this.findVideoUrl(body, vimeoUrl)
            ...
            if (course?.url) {
                ...
                if (size > headers['content-length']) {
                    console.log('size >  headers[\'content-length\']', size, headers['content-length'], response.request.uri.href);
                    return {
