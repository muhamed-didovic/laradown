...
exports.laraAll = async (opts = {}) => {
    ...
    const coursesFromSearch = file ? require(filePath) : logger.promise(crawler.getAllCoursesFromSearchAPI(opts), "Finding all courses from search..")//await crawler.getAllCoursesFromSearchAPI(opts) //
